...
<html lang="en">
<head>
    <h2><big><big>List Of Patients</big></big></h2><br>
...
while($row1=mysqli_fetch_assoc($result1))
{
    ...
    */echo '<span class="excerpt d-block">'.$row1['Username'].'</span>'; 
     ...
     <li><span class="fa fa-check mr-2"></span>Age : '.$row1['Age'].'</li>
                  ...
                  echo"<form action ='new_sample_doctor.php' method='post' enctype='multipart/form-data'><button type='submit' name='DELETE_x' value = '$USERNAME_XYZ' class='btn btn-primary d-block px-2 py-3'>View Report</button>
                    </form></div>
                </div>
            </div>
";
